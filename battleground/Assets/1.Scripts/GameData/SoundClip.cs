...
public class SoundClip
{
    ...
    /// <summary>
    ///     구간 재생 후 원하는 setTime으로 돌아가 반복 재생 루프 문
    /// </summary>
    ...
    public void FadeIn(float time, Interpolate.EaseType easeType) // 보간을 통해 다양한 그래프 곡선 공식들로 연출 및 움직임을 자연스럽게 해주는 기능.
    {
